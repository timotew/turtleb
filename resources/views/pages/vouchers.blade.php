...
<div class="row">
     <div class="col-12">
         <div class="card-box table-responsive">
             <h4 class="m-t-0 header-title">Vouchers List</h4>
             <p class="text-muted font-14 text-right">

                 <button type="button" class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-target="#myModal1"> Add Vouchers <i class="fa fa-plus m-l-5"></i> </button>
                           ...
                           <form action="#">
                             <div class="form-row">
                                 <div class="form-group col-md-6">
                                     <label for="title" class="col-form-label">Vouchers Title</label>
                                     <input type="text" class="form-control" id="title" placeholder="vouchers Title">
                                 </div>
                                 <div class="form-group col-md-6">
                                     <label for="gold" class="col-form-label">Redeem Gold Coins</label>
                             ...
                             <div class="form-row">
                                 <div class="form-group col-md-6">
                                     <label for="title" class="col-form-label">Vouchers Cost</label>
                                     <input type="text" class="form-control" id="title" placeholder="Vouchers Cost">
                                 </div>
                                 <div class="form-group col-md-6">
                                     <label for="gold" class="col-form-label">Upload Image</label>
