...
@section('content_header')
    ...
    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active">My Market</li>
                                    </ol>
@stop
...
<div class="row">
     <div class="col-12">
         <div class="card-box table-responsive">
             <h4 class="m-t-0 header-title">My Market List</h4>
                 ...
                 <div class="modal-dialog modal-lg">
                     <div class="modal-content">
                         <div class="modal-header">
                             ...
                             <h4 class="modal-title" id="myModalLabel">Product Title<br/><small><b>Location:</b> Kakinada</small></h4>
                      ...
                      <hr/>
                         <div class="row">
                                 <div class="col-md-6">
                                     <p class="mb-0"><b>Price:</b> 55,000</p>
                                 </div>
